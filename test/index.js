...
describe('RpcClient', function() {
  ...
  //     requestStub.restore()
  //     should.exist(error)
  //     error.message.should.equal('ION JSON-RPC: Connection Rejected: 401 Unnauthorized')
  //     done()
  //   })
  ...
  //     requestStub.restore()
  //     should.exist(error)
  //     error.message.should.equal('ION JSON-RPC: Connection Rejected: 403 Forbidden')
  //     done()
  //   })
  ...
  //     requestStub.restore()
  //     should.exist(error)
  //     error.message.should.equal('ION JSON-RPC: Work queue depth exceeded')
  //     done()
  //   })
  ...
  //     requestStub.restore()
  //     should.exist(error)
  //     error.message.should.equal('ION JSON-RPC: Request Error: write EPIPE')
  //     done()
  //   })
  ...
  //     requestStub.restore()
  //     should.exist(error)
  //     error.message.should.equal('ION JSON-RPC: Request Error: connect ECONNREFUSED')
  //     done()
  //   })
  ...
  //     requestStub.restore()
  //     should.exist(error)
  //     error.message.should.equal('ION JSON-RPC: Error Parsing JSON: Unexpected token o')
  //     done()
  //   })
  ...
  //     requestStub.restore()
  //     should.exist(error)
  //     error.message.should.equal('ION JSON-RPC: Error Parsing JSON: Unexpected end of input')
  //     done()
  //   })
